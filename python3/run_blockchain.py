...
# This is NOT Bitcoin's PoW algorithm, this is a very simple test. 
# Written by SnoothDogg Sept 2018 - Copyright 2018
...
sender = input("What is the sender's privatekey?  \n")
receiver = input("What is the receipient's wallet address?  \n")
